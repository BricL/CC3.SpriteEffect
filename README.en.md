...
2. Click the "Add Component button" and choose the effec you want.

> ATTENTION! Sometimes the effect may not show correctly the first time the component is added. Press the "Reload button" in the effect component's inspector to reload the effect and correct this issue.
